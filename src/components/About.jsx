...
const config = [
  ...
  { key: 'projetos', gap: `${NBSP}`, value: 'friday, axl, smp, site' },
      ...
      <div className="wrap">
        ...
        <div className="about-grid">
          <div className="reveal d1">
            ...
            <p>
              Fundador da <b>Axolotl BR</b> — comunidade de player para player — e criador de
              coisa demais: bot de Discord, organizador de arquivos, um SMP e um repo em que
              escrevi &quot;axolotl&quot; em todas as linguagens (sim, eu sei).
            </p>
            <p>
              Do primeiro rascunho no figma até o deploy final. Front, back e infra com o mesmo
              padrão e a mesma vibe — sem template genérico, sem demo preguiçosa.
            </p>
